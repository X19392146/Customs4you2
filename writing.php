...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="text-center">
            <a href="create.php" class="btn btn-outline-dark" style="background-color: #80bfff">+ Create a new post</a>
        </div>
        ...
        <div class="row">
                ...
                <div class="col-12 col-lg-4 d-flex justify-content-center">
                    <div class="card text-white btn btn-outline-dark mt-5" style="width: 18rem; background-color: #80bfff">
                        <div class="card-body">
